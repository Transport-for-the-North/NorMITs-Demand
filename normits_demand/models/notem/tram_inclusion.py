...
from normits_demand.core.data_structures import DVector as dvec
...
class TramInclusion:
    ...
    def run(self,
        ...
        notem_tram_seg, tram_data = self._read_tram_data(verbose)
        tram_msoa = self._tram_infill_msoa(notem_tram_seg, tram_data, verbose)
        north_msoa=
    ...
    def _tram_infill_north(self, notem_tram_seg, tram_data, verbose):
